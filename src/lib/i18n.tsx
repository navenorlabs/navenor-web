...
const translations: Translations = {
  en: {
    ...
    "services.t1.desc": "Lightning-fast static webs, SEO dominance, and lead-generation funnels engineered to convert.",
    "services.t1.b1": "Custom architecture",
    ...
    "services.t2.desc": "Bespoke full-stack architecture, corporate dashboards, internal tools, and robust database management.",
    "services.t2.b1": "Full-stack product engineering and DevOps deployment",
    ...
    "pricing.p2.f1": "Full-stack development and DevOps deployment",
  ...
  es: {
    ...
    "services.t1.desc": "Webs estáticas ultrarrápidas, dominio de SEO y embudos de generación de leads diseñados para convertir.",
    "services.t1.b1": "Arquitectura personalizada",
    ...
    "services.t2.desc": "Arquitectura full-stack a medida, dashboards corporativos, herramientas internas y gestión de bases de datos robusta.",
    "services.t2.b1": "Ingeniería de producto full-stack y despliegue DevOps",
    ...
    "pricing.p2.f1": "Desarrollo full-stack y despliegue DevOps",
  ...
  ca: {
    ...
    "services.t1.desc": "Webs estàtiques ultraràpides, domini de SEO i embuts de generació de leads dissenyats per convertir.",
    "services.t1.b1": "Arquitectura personalitzada",
    ...
    "services.t2.desc": "Arquitectura full-stack a mida, dashboards corporatius, eines internes i gestió de bases de dades robusta.",
    "services.t2.b1": "Enginyeria de producte full-stack i desplegament DevOps",
    ...
    "pricing.p2.f1": "Desenvolupament full-stack i desplegament DevOps",
