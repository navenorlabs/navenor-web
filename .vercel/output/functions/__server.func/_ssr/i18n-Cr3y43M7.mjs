...
//#region node_modules/.nitro/vite/services/ssr/assets/i18n-Cr3y43M7.js
...
var LanguageProvider = ({ children }) => {
	...
	(0, import_react.useEffect)(() => {
		if (typeof window !== "undefined") {
			const savedLang = localStorage.getItem("navenor-lang");
			if (savedLang && [
				"en",
				"es",
				"ca"
			].includes(savedLang)) setLanguageState(savedLang);
			else {
	...
	const setLanguage = (lang) => {
		if (typeof window !== "undefined") localStorage.setItem("navenor-lang", lang);
...
//#endregion
export { useTheme as i, ThemeProvider as n, useLanguage as r, LanguageProvider as t };
